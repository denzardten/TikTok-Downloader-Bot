...
def help(client, message):
    kb = [[InlineKeyboardButton('Channel 🛡', url=chnnl),InlineKeyboardButton('Repo 🔰', url="https://github.com/denzardten/TikTok-Downloader-Bot/")]]
    reply_markup = InlineKeyboardMarkup(kb)
...
def tiktok_dl(client, message):
    ...
    headers = {
      ...
      'x-rapidapi-key': "49590df1b7msh5165aa5ced3a0c1p10074cjsnb8252facfc5c"
    }
